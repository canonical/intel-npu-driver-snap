...
class TestParseVersion(unittest.TestCase):
    ...
    def test_version_with_suffix(self):
        self.assertEqual(min_kernel_version.parse_version("6.8.0-generic"), (6, 8, 0))
    
    def test_version_with_multiple_parts(self):
        self.assertEqual(min_kernel_version.parse_version("4.9.123-rt-10"), (4, 9, 123, 10))
    
    def test_text_and_numbers(self):
        self.assertEqual(min_kernel_version.parse_version("linux-v4.2-rc1"), (4, 2, 1))
